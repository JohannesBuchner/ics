...
public class MockAESObject extends AESObject {
	...
	public MockAESObject() throws NoSuchAlgorithmException, NoSuchPaddingException {
	}
	
	public MockAESObject(String key) throws NoSuchAlgorithmException, NoSuchPaddingException {
	}

	/* (non-Javadoc)
	 * @see com.jakeapp.jake.ics.impl.sockets.filetransfer.AESObject#decrypt(java.io.InputStream)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jakeapp.jake.ics.impl.sockets.filetransfer.AESObject#encrypt(java.io.OutputStream)
	 */
	@Override
