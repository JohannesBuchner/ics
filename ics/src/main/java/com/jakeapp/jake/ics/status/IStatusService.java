...
public interface IStatusService {
	...
	/**
	 * Connects and authenticates on the used network service. If the service is
	 * already logged in, a logout is done first.
	 * 
	 * @param userid
	...
	/**
	 * Logs out and disconnects from the used network service. If the service is
	 * already logged out, this does nothing.
	 * 
	 * @throws NetworkException
